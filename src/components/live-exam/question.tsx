...
export const Question = ({
  ...
  return (
    <div
      className={`
        RadioGruopContainer
        ${isSelected ? "RadioGroupContainer__active shadow-sm border border-brand-primary-300" : ""}
      ...
      <div className="flex items-start gap-3 p-4">
        <RadioGroup.Item
          className={`
            ...
            hover:scale-105 hover:shadow-md transition-all duration-200 ease-out overflow-hidden over
            ${
              isSelected
                ? "border-3 border-brand-primary-600 ring-2 ring-brand-primary-100"
        ...
        >
          <RadioGroup.Indicator className="RadioGroupIndicator">
            <div
              className="absolute w-3 h-3 bg-brand-primary-600 rounded-full
              animate-[popIn_200ms_ease-out_forwards]"
            />
