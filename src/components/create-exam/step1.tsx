...
export function Answers({ index }: AnswersProps) {
  ...
  const radioGroupClassName =
    questionType === "tf"
      ? "grid grid-cols-2 gap-2 w-full min-h-[64px]"
      : "flex flex-col gap-2";
                      ...
                      <FormItem>
                        <div className="relative">
                          <Input
                            ...
                            className={cn(
                              ...
                              isOverLimit
                                ? "border-ui-error-500 focus:ring-ui-error-500"
                                : ""
                            )}
                        ...
                        {isOverLimit && (
                          <p className="text-red-500 text-sm mt-1">
                            The answer option exceeds the maximum allowed
                            200 characters.
                          </p>
                        )}
                        <FormMessage />
...
export const Step1 = ({ onNext }: Step1Props) => {
  ...
  const remove = (index: number) => {
    ...
    setActiveQuestionIndex((prev) =>
      Math.min(prev > 0 ? prev - 1 : prev, fields.length - 2)
    );
  };
    ...
    <Card className="flex-1 flex flex-col overflow-y-auto">
      <CardHeader>
        <Button
          onClick={() => {}}
          variant="default"
          className="flex items-center bg-transparent justify-center stroke-current text-3xl align-middle cursor-pointer hover:bg-transparent hover:cursor-default"
          size="icon"
          pill
        >
          ☺︎
        ...
        <CardHeaderContent>
          ...
          <CardDescription>
            Create questions that inspire, challenge, and engage participants
      ...
      <CardContent className="flex overflow-y-auto flex-1 gap-6 flex-col md:flex-row relative p-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                 ...
                 <FormControl>
                    <div className="border border-greyscale-light-200 rounded-2xl min-h-[240px] max-h-[960px] bg-base-white resize-y overflow-y-auto ring-0 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-brand-primary-400">
                      <MarkdownEditor
        ...
        <Card>
          <CardHeader className="px-5 min-h-[68px] max-h-[68px]">
            Questions List
          </CardHeader>
