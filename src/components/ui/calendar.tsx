  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_next: "absolute right-1 hover:bg-brand-primary-200 hover:border-brand-primary-800 hover:text-brand-primary-950",
        ...
        day_outside:
          "day-outside text-greyscale-light-400 opacity-50 aria-selected:bg-accent/50 aria-selected:text-greyscale-light-400 aria-selected:opacity-30",
