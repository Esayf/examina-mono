  ...
  "inline-flex items-center justify-center box-border text-normal font-base whitespace-nowrap transition-colors rounded-xl ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-transparent text-brand-primary-950 border-2 border-brand-primary-950 hover:bg-brand-secondary-200 hover:text-brand-primary-900 disabled:bg-greyscale-light-50 disabled:text-greyscale-light-300 disabled:border-greyscale-light-300 disabled:stroke-greyscale-light-300",
        secondary: "bg-brand-secondary-200 text-brand-primary-800 hover:bg-brand-secondary-300",
        tertiary:
