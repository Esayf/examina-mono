...
const buttonVariants = cva(
  "inline-flex items-center justify-center box-border text-normal font-base whitespace-nowrap transition-colors rounded-xl ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-brand-primary-900 text-brand-secondary-200 border-2 border-brand-primary-950 hover:bg-brand-primary-800 disabled:bg-greyscale-light-200 disabled:text-greyscale-light-400 disabled:border-greyscale-light-300",
        outline:
          "bg-transparent text-brand-primary-950 border-2 border-brand-primary-950 hover:bg-brand-secondary-100 hover:text-brand-primary-900 disabled:bg-greyscale-light-50 disabled:text-greyscale-light-300 disabled:border-greyscale-light-300 disabled:stroke-greyscale-light-300",
        secondary:
          "border-2 border-brand-primary-950 bg-brand-secondary-100 text-brand-primary-800 hover:bg-brand-secondary-50",
        tertiary:
          "bg-brand-tertiary-500 text-brand-primary-950 hover:bg-brand-tertiary-400 border-2 border-brand-primary-950",
        destructive:
        ...
        ghost:
          "bg-transparent text-brand-primary-900 hover:bg-brand-secondary-200 hover:text-brand-primary-800 disabled:text-greyscale-light-400 active:bg-brand-secondary-100",
        link: "text-brand-primary-950 underline-offset-4  hover:bg-brand-secondary-200 disabled:bg-transparent  disabled:text-greyscale-light-400 selected:bg-brand-secondary-200 selected:font-bold",
        "date-picker":
          "flex border-box items-center justify-between rounded-2xl border border-input bg-background text-md text-brand-primary-950 font-light focus:outline-none focus:ring-2 focus:ring-brand-primary-800 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 disabled:border-greyscale-light-400",
      },
      size: {
