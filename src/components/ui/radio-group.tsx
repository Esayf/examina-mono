...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "RadioGroupItem",
        "aspect-square h-6 w-6 rounded-full border border-brand-primary-300 text-brand-primary-500",
        "hover:bg-brand-primary-50",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary-200 focus-visible:ring-offset-2",
